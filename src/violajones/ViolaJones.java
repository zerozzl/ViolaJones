...
//		String root = "/home/hadoop/ProgramDatas/MLStudy/FaceDection/";
		...
		List<IntegralImage> trainDatas = FileUtils.loadAdaBoostDatas(dataFile, imgSize, imgSize);
	...
	private static void trainCascadeAdaBoost() {
		int imgSize = 24;
		double eachDR = 0.99, eachFAR = 0.3, finalFAR = 0.0005;
...
//		Map<HaarLikeFeature, Double> model = adaBoost.train(sc, sparkCores, T);
		...
		cascade.train(eachDR, eachFAR, finalFAR);
